...
//void Calculator::GetInputValue()
//{
//	wxString txtValue = textBox->GetValue();
//	double fValue = 0;
//	txtValue.toCalculateuble(&fValue);
//}



#pragma region Calculate Equation 
//void Calculator::CalculateEquation()
//{
//	if (nswer.size() == 0)
//	{
//		return;
//	}
//	else if (calcAnswer.size() < 2 && calcAnswer.size() != 0)
//	{
//		calcAnswer = calcAnswer[0];
...
//		case divide:
//		{
//			calcAnswer = calcAnswer[0] / calcAnswer[1];
//
//			break;
//		}
//		// Mult
...
//		case mod:
//		{
//			calcAnswer = fmod(calcAnswer[0], calcAnswer[1]);
//
//			break;
//		}
//		// Negate
...
//		}
//	}
//	calcAnswer = calcAnswer[calcAnswer.size() - 1];
//	if (calcAnswer == (int)calcAnswer)
//	{
//		*outputTxt << (int)calcAnswer;button4
//	}
//	else
//	{
//
